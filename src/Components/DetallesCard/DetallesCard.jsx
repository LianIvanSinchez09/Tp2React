...
const DetallesCard = ({ item }) => {
    ...
    <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        ...
        <div className="md:hidden">
            <img className="w-full" alt={DetallesInfo?.name} src="https://i.ibb.co/QMdWfzX/component-image-one.png" />
        ...
        <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
            ...
            <p className="text-sm leading-none text-gray-600 dark:text-gray-300 ">{DetallesInfo?.name}</p>
            ...
            <div className="flex items-center justify-center">
                ...
                <div className="w-6 h-6 bg-linear-to-b from-gray-900 to-indigo-500 ml-3 mr-4 cursor-pointer"></div>
            ...
            <div>
            <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 dark:text-gray-300 mt-7"></p>
